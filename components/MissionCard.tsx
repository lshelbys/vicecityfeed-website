...
export function MissionCard({ mission }: MissionCardProps) {
  return (
    <article className="flex h-full flex-col gap-4 rounded-2xl bg-surface p-5 transition-[background-color,transform] duration-300 ease-out hover:-translate-y-1 hover:bg-raised">
